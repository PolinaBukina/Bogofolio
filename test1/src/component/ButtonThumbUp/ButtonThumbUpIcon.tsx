...
export const ButtonThumbUpIcon = ({ color = '#313037' }: Props) => {
    // const [state, setState] = useState<любой тип>() - хук, состояний может быть много и не только объекты
...
// export class ButtonThumbUpIcon2 extends Component<Props, State> {
//     constructor(props: Props) {
//         super(props)

//         this.state = { // только один стейт и он всегда объект
//             name: 'Vasya'
//         }
//     }
